...
_CONFIGS = [
    ...
    TrainConfig(
        name="cylinder2reactor_agilex_rtc",
        model=pi0_config.Pi0RTCConfig(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
    ...
    TrainConfig(
        ...
        data=LerobotAgilexDataConfig(
            ...
            root="/mnt/hdy/organ_data/organ_data_le/solid_atom/",
            assets=AssetsConfig(asset_id="boat2balance_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        ...
        data=LerobotAgilexDataConfig(
            ...
            root="/mnt/hdy/organ_data/organ_data_le/solid_atom/",
            assets=AssetsConfig(asset_id="solid2reactor_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        ...
        data=LerobotAgilexDataConfig(
            ...
            root="/mnt/hdy/organ_data/organ_data_le/solid_atom/",
            assets=AssetsConfig(asset_id="press_button_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        ...
        data=LerobotAgilexDataConfig(
            ...
            root="/mnt/hdy/organ_data/organ_data_le/solid_atom/",
            assets=AssetsConfig(asset_id="solid2boat_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        name="place_distillation_agilex",
        model=pi0_config.Pi0Config(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
            repo_ids=[
                "distill_place_distillation_rack"
            ],
            root="/mnt/hdy/organ_data/organ_data_le/boil_atom/",
            assets=AssetsConfig(asset_id="place_distillation_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        name="funnel2rack_agilex",
        model=pi0_config.Pi0Config(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
            repo_ids=[
                "distill_return_funnel_to_rack"
            ],
            root="/mnt/hdy/organ_data/organ_data_le/boil_atom/",
            assets=AssetsConfig(asset_id="funnel2rack_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        name="turn_knob_agilex",
        model=pi0_config.Pi0Config(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
            repo_ids=[
                "distill_turn_reactor_knob"
            ],
            root="/mnt/hdy/organ_data/organ_data_le/boil_atom/",
            assets=AssetsConfig(asset_id="turn_knob_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        ...
        data=LerobotAgilexDataConfig(
            ...
            root="/mnt/hdy/organ_data_le/boil_atom",
            assets=AssetsConfig(asset_id="boil_distill_return_funnel_to_rack_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        name="boil_distill_return_funnel_to_rack_agilex_rtc",
        model=pi0_config.Pi0RTCConfig(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
    ...
    TrainConfig(
        name="boil_distill_place_distillation_rack_agilex",
        model=pi0_config.Pi0Config(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
            ...
            root="/mnt/hdy/organ_data_le/boil_atom",
            assets=AssetsConfig(asset_id="boil_distill_place_distillation_rack_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        name="boil_distill_place_distillation_rack_agilex_rtc",
        model=pi0_config.Pi0RTCConfig(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
    ...
    TrainConfig(
        name="boil_distill_turn_reactor_knob_agilex",
        model=pi0_config.Pi0Config(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
            ...
            root="/mnt/hdy/organ_data_le/boil_atom",
            assets=AssetsConfig(asset_id="boil_distill_turn_reactor_knob_agilex"),
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
    ...
    TrainConfig(
        name="boil_distill_turn_reactor_knob_agilex_rtc",
        model=pi0_config.Pi0RTCConfig(pi05=True, active_arm="left"),
        data=LerobotAgilexDataConfig(
            repo_id=None,
            use_multi_repo=True,
